...
function ThreeSixtyPlayer() {
  ...
  this.config = {
    ...
    playRingColorMetadata: 'rgba(128,192,256,0.1)', // how much has played when metadata is present
  ...
  waveformDataColor: '#0099ff',
  waveformDataDownsample: 10,
  waveformDataOutside: true,
  waveformDataConstrain: false,
  waveformDataLineRatio: 0.08,

  useEQData: true,
  eqDataColor: '#52ccb3',
  eqDataDownsample: 2,
  eqDataOutside: true,
  eqDataLineRatio:1.69,
