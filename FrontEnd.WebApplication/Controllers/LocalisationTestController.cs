...
namespace FrontEnd.WebApplication.Controllers
{
    ...
    public class LocalisationTestController : BaseController
    {
        private RLIEntities db = new RLIEntities();
        // GET: LocalisationTest
        public async System.Threading.Tasks.Task<ActionResult> LocalizationFileUpload()
        {

            return View();
        }

        public async System.Threading.Tasks.Task<ActionResult> JExcelLocalisation()
        {
        ...
        public async System.Threading.Tasks.Task<ActionResult> JExcelLocalisationEdit()
        {
