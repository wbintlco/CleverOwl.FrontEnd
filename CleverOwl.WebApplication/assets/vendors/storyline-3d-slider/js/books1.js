	...
	function init() {
		...
		$books.each( function() {
			...
			$bookview.on( 'click', function() {
				...
				var $this = $( this );			
				if(!$bookvieww.hasClass('bespoke-active')){
			...
			if( $content.length > 1 ) {
				...
				var $navPrev = $( '<span class="bk-page-prev" style="padding-top:2px!important;" ><i class="icon-chevron-left"></i></span>' ),
					$navNext = $( '<span class="bk-page-next" style="padding-top:2px!important;"><i class="icon-chevron-right"></i></span>' );
