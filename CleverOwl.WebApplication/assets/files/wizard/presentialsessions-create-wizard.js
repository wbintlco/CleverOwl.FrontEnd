    ...
    var initButtons = function () {
        ...
        btnComplete.on('click', function (e) {
            ...
            formEl.ajaxSubmit({
                ...
                success: function (data) {
                    var PresentialSessionKey = data.PresentialSessionKey;
                    ...
                    swal({
                        ...
                        "cancelButtonText": "Take Attendance"
                    }).then((result) => {
                        if (result.value) {
                            mApp.block(wizardEl);
                            mApp.progress(btnComplete);
                            ...
                            var currentSchool = $('#SchoolsDropDown').val();
                            var currentGrade = $('#GradesDropDown').val();
                            console.log($('#GradesDropDown').val());
                            console.log($('#SchoolsDropDown').val());
                            window.location = AttendanceURL + '/' + PresentialSessionKey;
                        }
                    });
                },
                error: function (xhr, status, error) {
